import CtaContact from '@/components/main-site/CtaContact';
import ServiceCard from '@/components/main-site/ServiceCard';
...
export default async function Home() {
  ...
  const services = [
    {
      title: t('homepage.services.items.0.title'),
      description: t('homepage.services.items.0.description'),
      imageSrc: "/images/services/service-1.jpg",
      link: "#"
    },
    {
      title: t('homepage.services.items.1.title'),
      description: t('homepage.services.items.1.description'),
        ...
        ">
          ...
          ">
            ...
            <p className="
              ...
              drop-shadow-md
            ">
              <span className="text-white/90">{t('homepage.hero.specialist')}</span> <span className="font-semibold">{t('homepage.hero.fire_safety')}</span> <span className="text-white/90">{t('homepage.hero.and')}</span> <span className="font-semibold">{t('homepage.hero.building_accessibility')}</span>
            </p>
            <div className="
              w-24
              h-1
            ...
            ">
              ...
              ">
                ...
                <p className="
                  ...
                  md:mb-6
                ">
                  {t('homepage.mission.description1')}
                </p>
                <p className="
                  text-base
                  sm:text-lg 
                  ...
                  dark:text-gray-300
                ">
                  {t('homepage.mission.description2')}
                </p>
              </div>
            ...
            ">
              ...
              ">
                ...
                <p className="
                  ...
                  mb-6
                ">
                  {t('homepage.founder.description')}
                </p>
